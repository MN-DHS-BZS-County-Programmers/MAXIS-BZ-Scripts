...
MsgBox "F10" 'TESTING'
	...
	For all_clts = 0 to UBOUND(FULL_EMER_ARRAY, 2) 
		...
		If FULL_EMER_ARRAY(include_clt, all_clts) = checked Then total_case_unea = total_case_unea + FULL_EMER_ARRAY(clt_rsdi_income, all_clts) + FULL_EMER_ARRAY(clt_ssi_income, all_clts) + FULL_EMER_ARRAY(clt_other_unea_1_amt, all_clts) + FULL_EMER_ARRAY(clt_other_unea_2_amt, all_clts)
	Next
...
MsgBox FULL_EMER_ARRAY(clt_name, 0)
MsgBox "F12" 'TESTING'
MsgBox UBOUND(FULL_EMER_ARRAY, 2)
...
'FPG and Thrifty standards'
	...
	ElseIf HH_size = 10 then
		...
		thrifty_food = 1441
	ElseIf HH_size > 10 Then 
		EA_FPG_size = 8278 + (697 * (HH_size - 10))
		EGA_FPG_size = 8202 + (693 * (HH_size - 10))
		thrifty_food = 1441 + (144 * (HH_size - 10))
	End If
end function
	...
	Do
		Do 
			...
			BeginDialog emer_dlg, 0, 0, 406, 320, "Emergency QuickScreen"
			  ...
			  DropListBox 140, 15, 120, 45, "Select One..." & HH_Memb_DropDown, case_name
			  ...
			  DropListBox 15, 170, 100, 45, "Select One..." & HH_Memb_DropDown, income_1_memb
			  EditBox 120, 170, 35, 15, income_1_amt
			  EditBox 165, 170, 180, 15, income_1_type
			  DropListBox 15, 185, 100, 45, "Select One..." & HH_Memb_DropDown, income_2_memb
			  EditBox 120, 185, 35, 15, income_2_amt
			  EditBox 165, 185, 180, 15, income_2_type
			  DropListBox 15, 200, 100, 45, "Select One..." & HH_Memb_DropDown, income_3_memb
			  EditBox 120, 200, 35, 15, income_3_amt
			  EditBox 165, 200, 180, 15, income_3_type
			  DropListBox 15, 215, 100, 45, "Select One..." & HH_Memb_DropDown, income_4_memb
	...
	Do
		Do
			...
			BeginDialog emer_dlg, 0, 0, 470, 435, "Emergency Assistance Screening"
			  ...
			  Text 115, 50, 150, 10, "From: " & dateadd("d", -30, app_date)  & "   To: " & dateadd("d", -1, app_date)
			  'HH Comp information
