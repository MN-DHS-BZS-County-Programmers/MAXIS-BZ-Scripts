...
DIM EDRS_DISQ_button, EMERGENCY_button, EMPLOYMENT_PLAN_OR_STATUS_UPDATE_button, EMPLOYMENT_VERIFICATION_button, ES_REFERRAL_button, EXPEDITED_SCREENING_button
DIM EXPLANATION_INCOME_BUDGETED_button, FRAUD_INFO_button
...
EndDialog
	  ...
	  ButtonGroup ButtonPressed
	    ...
	    PushButton 5, 130, 100, 10, "EDRS DISQ MATCH FOUND", EDRS_DISQ_button
	  ...
	  Text 55, 190, 295, 10, "--- New 11/2015!!! Template for sending an MFIP or DWP referral to employment services."
	  ...
	  Text 5, 5, 435, 10, "Notes scripts main menu: select the script to run from the choices below. Notes with autofill functionality marked with an asterisk (*)."
	  Text 110, 130, 335, 10, "--- NEW 01/2016!!! Template for SNAP recipients who've had an eDRS DISQ match. Per TE02.08.127. "
	EndDialog
