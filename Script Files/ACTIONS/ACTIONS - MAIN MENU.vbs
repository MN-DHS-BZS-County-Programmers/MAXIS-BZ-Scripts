...
'DIALOGS----------------------------------------------------------------------------------------------------
BeginDialog ACTIONS_scripts_main_menu_dialog, 0, 0, 456, 250, "Actions scripts main menu dialog"
  ButtonGroup ButtonPressed
    CancelButton 395, 230, 50, 15
    ...
    PushButton 5, 80, 75, 10, "FSET sanction", FSET_sanction_button
    ...
    PushButton 5, 150, 60, 10, "PA verif request", PA_VERIF_REQUEST_button
    PushButton 5, 165, 70, 10, "Paystubs Received", PAYSTUBS_RECEIVED_button
    PushButton 5, 190, 45, 10, "Send SVES", SEND_SVES_button
    PushButton 5, 205, 55, 10, "Transfer case", TRANSFER_CASE_button
    PushButton 5, 230, 85, 10, "Update worker signature", UPDATE_WORKER_SIGNATURE_button
  ...
  Text 70, 125, 380, 20, "--- Creates a JOBS panel, a CASE/NOTE, and a TIKL, when client reports a new job. For new HIRE messages on the DAIL, use the DAIL scrubber instead."
  Text 70, 150, 320, 10, "--- Creates a Word document with PA benefit totals for other agencies to determine client benefits."
  Text 80, 165, 370, 20, "--- Enter in paystubs on one dialog, and it puts that information on JOBS (both retrospective and prospective if applicable), as well as the PIC and HC pop-up, and it'll case note the income as well."
  Text 55, 190, 90, 10, "--- Sends a SVES/QURY."
  Text 65, 205, 380, 20, "--- SPEC/XFERs a case, and can send a memo to the new client. For in-agency as well as between agencies (out-of-county XFERs)."
  Text 95, 230, 185, 10, "--- Updates the default worker signature on your scripts."
  ...
  Text 90, 80, 275, 10, "---Updates WREG panel and case notes for imposing or resolving a FSET sanction."
EndDialog
