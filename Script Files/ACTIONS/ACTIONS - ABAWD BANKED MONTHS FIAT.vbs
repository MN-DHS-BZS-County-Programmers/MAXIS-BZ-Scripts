'STATS GATHERING----------------------------------------------------------------------------------------------------
name_of_script = "ACTIONS - ABAWD BANKED MONTHS FIAT.vbs"
start_time = timer
...
BeginDialog case_number_dialog, 0, 0, 251, 230, "ABAWD BANKED MONTHS FIATER"
  ...
  Text 30, 90, 200, 25, "This script will FIAT eligibilty results, income and deductions for each HH member with pending SNAP results for months where ABAWD banked months are being used. "
